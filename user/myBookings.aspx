...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" Runat="Server">
    ...
    <asp:ListView ID="myBookingsListView" runat="server" DataKeyNames="bookingId" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="myBookingsListView_SelectedIndexChanged">
        <EmptyDataTemplate>
            <span>No bookings here for now, check out the latest leased cars <asp:HyperLink ID="leasedCarsHyperLink" runat="server" NavigateUrl="~/Default.aspx">here</asp:HyperLink>.</span>
        </EmptyDataTemplate>
        <ItemTemplate>
            <div style="">
            Tenant:
