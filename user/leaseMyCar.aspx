...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" Runat="Server">
    ...
    <div style="display: flex; justify-content: center;">
        <div class="form-container">
            ...
            <br />
            <asp:DropDownList class="input-style" ID="carsDropdownList" runat="server" DataSourceID="SqlDataSource1"
                DataTextField="model" DataValueField="Id" AppendDataBoundItems="True">
                <asp:ListItem Selected="True" Text="Select a car..." Value=""></asp:ListItem>
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT model, Id FROM Cars WHERE (owner_id = @owner_id) AND (Id NOT IN (SELECT car_id FROM rentals))">
                <SelectParameters>
            ...
            <asp:RegularExpressionValidator ID="priceRegularExpressionValidator"
                ValidationExpression="^\d{0,8}(\.\d{1,2})?$" runat="server" ErrorMessage="Please enter a correct price"
                ControlToValidate="textBoxPrice" Display="Dynamic">
