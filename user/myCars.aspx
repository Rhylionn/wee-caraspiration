        ...
        <EditItemTemplate>
            <div style="display: flex; justify-content: center;">
                ...
                <div>
                    ...
                    <asp:Image ID="Image1" style="width: 400px; display: flex; margin: 10px 12% 0; border-radius: 10px;" runat="server" ImageUrl='<%# Eval("img") %>' />
                    <br />
        ...
        <ItemTemplate>
            <div style="display: flex; justify-content: center;">
                <div class="row-form-container">
                    ...
                    <asp:Image ID="Image1" style="width: 300px; margin-top: 10px; border-radius: 10px;" runat="server"
                        ImageUrl='<%# Eval("img") %>' />
                    <br />
